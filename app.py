...
# ---------------------- رفع ملف embeddings ----------------------
uploaded_file = st.file_uploader("📥 Importer votre fichier embeddings (.pkl)", type="pkl")
if uploaded_file:
    bytes_data = uploaded_file.read()
    data = pickle.load(io.BytesIO(bytes_data))
    ...
    with right:
        ...
        pdf_upload = st.file_uploader("📄 Télécharger un fichier PDF", type="pdf", key="pdf_uploader")

else:
    st.warning("📌 Veuillez importer le fichier embeddings_from_drive.pkl pour continuer.")
